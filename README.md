...
| <a name="input_node_drain_docker_registry"></a> [node\_drain\_docker\_registry](#input\_node\_drain\_docker\_registry) | Docker registry to use for the node drain CronJobs. If not specified, the `default_docker_registry` variable will be used. | `string` | `""` | no |
...
| <a name="input_remove_terminating_pods_docker_registry"></a> [remove\_terminating\_pods\_docker\_registry](#input\_remove\_terminating\_pods\_docker\_registry) | Docker registry to use for the remove terminating pods CronJobs. If not specified, the `default_docker_registry` variable will be used. | `string` | `""` | no |
...
| <a name="input_working_hours_docker_registry"></a> [working\_hours\_docker\_registry](#input\_working\_hours\_docker\_registry) | Docker registry to use for the working hours CronJobs. If not specified, the `default_docker_registry` variable will be used. | `string` | `""` | no |
