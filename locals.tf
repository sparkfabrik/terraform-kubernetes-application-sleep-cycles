locals {
  ...
  working_hours_cronjob_timezone           = var.cronjob_timezone != "" ? var.cronjob_timezone : var.default_cronjob_timezone
  ...
  final_rbac_cluster_scoped = distinct(concat(
    var.working_hours_enabled ? local.rbac_cluster_scoped_application_sleep_cycles : [],
